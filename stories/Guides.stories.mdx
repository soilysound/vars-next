        ...
        <div className="flex-wrap gap-900">
              ...
              <div className="grid" style={{ "--basis": "160px" }}>
				...
				<div className="font-list flex-wrap">
					...
					<Canvas>
						<p className="font-size-100" data-label="--font-size-100: (14-16px)">Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque distinctio obcaecati exercitationem nulla eaque, repudiandae tempore tenetur corporis delectus esse, nemo vel reiciendis dolore fugiat? Alias, consequuntur? Eligendi, voluptatibus unde?</p>
